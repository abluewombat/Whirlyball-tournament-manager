...
export async function TournamentManagementContent({
  searchParams,
  embedded = false
}: {
        ...
        {tournaments.map((tournament) => (
          <article className="card" key={tournament.id}>
            ...
            <div className="actions section">
              <a className="button" href={`/admin/dashboard?view=teams&tournament=${tournament.slug}`}>Manage Teams</a>
              <a className="button secondary" href={`/admin/dashboard?view=schedule&tournament=${tournament.slug}`}>Schedule</a>
